[1] Introduction to Medicine and Medical Science (IMMS).
Genetics: 
...
[4] Gastrointestinal tract and liver (GI-L).  
...
[7] Skin, UroGenital, Endocrine and Reproduction (SUGER). 
...
[14] Early Years General Practice (EYGP).
